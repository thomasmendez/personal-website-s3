...
export default {
  title: 'Components/SoftwareEngineeringProjects',
  component: SoftwareEngineeringProjects,
  argTypes: {
    arrayOfObjects: { control: 'array' },
  },
};

const Template = args => <SoftwareEngineeringProjects {...args}/>;

export const SoftwareEngineeringProjectsStory = Template.bind({});
SoftwareEngineeringProjectsStory.args = {
  arrayOfObjects: [
    {
