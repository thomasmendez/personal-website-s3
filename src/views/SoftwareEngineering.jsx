...
const PROJECTS = [
  ...
  },
  {
    ...
    teamSize: 5,
    teamRoles: ['Front-End Developer', 'Back-End Developer', 'Unit Testing and Continuous Integration', 'GCP Deployment'],
    cloudServices: [
    ...
    media: NoblePrizesImg,
    mediaAlt: 'Noble Prizes Img',
    mediaTitle: 'Noble Prizes Features',
    mediaDescription: 'Visitors can view the different laureates, countries that they are from, and different noble prize categories they won. Users can also search for a particular set of data they wish to see in the page.',
    repository: 'https://gitlab.com/thomasmendez/cs329e-idb',
  },
  {
    title: 'Custom Clothing Brand Website',
    description: 'Dynamic clothing brand website that allows users to browse the brand\'s selection of products.',
    ...
    teamSize: 2,
    teamRoles: ['Full-Stack Developer'],
    tools: [
      'HTML',
      'CSS',
      'Bootstrap',
    ...
    media: CustomClothingBrandWebsite,
    mediaAlt: 'Clothing Brand Website',
    mediaTitle: 'Clothing Brand Features',
    mediaDescription: 'Users can interact with the website to place orders, contact the brand, add products to their cart, and see all products available through a database.Dynamic clothing brand website that allows users to browse the brand\'s selection of products. Users can interact with the website to place orders, contact the brand, add products to their cart, and see all products available from the database.',
  },
];
