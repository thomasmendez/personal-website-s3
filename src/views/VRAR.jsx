...
const PROJECTS = [
  {
    ...
    teamSize: 6,
    teamRoles: ['3 C# Unity Developers', '2 3D Modelers', '1 Game Designer', '1 Music Producer'],
    tools: [
      'Unity',
      'Steam VR Plugin',
      'HTC Vive',
    ...
    mediaDescription: 'HTC Vive Room Scale VR Game. Mystery / Horror VR Environment. Player can interact with elements in their environment. Player can obtain special items to clear different parts of the level',
    youTubeLink: 'https://www.youtube.com/watch?v=DBAIfIF99wQ&ab_channel=HaoyangLi',
  },
  {
    ...
    mediaDescription: 'User can select a 3D Object to place in their AR Environment. User can scale, move, rotate, and delete placed objects. User can search for a placed object and will be shown the direction it was placed at. User can place a custom sign with text or image from phone.',
  ...
  },
  {
    ...
    mediaDescription: 'User can play a AR game similar to curling. 2 Players take turns sharing the device to aim at the target in the board.',
  ...
  },
  {
    ...
    mediaDescription: 'User can grab objects that are on the ground and throw them at the audience. User can move around the 3D space and dodge incoming objects that are being thrown at.',
    downloadLink: 'https://utexas.app.box.com/s/d4zsulbdt0sxgd4jv8h7civgbcqvtsz5',
  },
];
